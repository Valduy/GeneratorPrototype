...
namespace GameEngine.Graphics
{
    ...
    public class Camera
    {
        ...
        public Camera(Window window, Vector3 position)
        {
            _window = window;
            Position = position;
        }
        ...
        public float AspectRatio => _window.Size.X / (float)_window.Size.Y;
        ...
        {
            get => _zoom;
            set => _zoom = MathHelper.Max(1, value);
        }
        ...
        public Matrix4 GetProjectionMatrix()
        {
            switch (Projection)
            {
                ...
                case Projection.Orthographic:
                    return Matrix4.CreateOrthographic(_window.Size.X / Zoom, _window.Size.Y / Zoom, 0.1f, 100.0f);
                default:
